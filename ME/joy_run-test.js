...
//下面给出好友邀请助力的示例填写规则
let invite_pins = ['jd_5936a981e2178,jd_795e9688450eb,jd_780f6fb3e2795,jd_YPtTiIFkkvgm,jd_47a64747baa1a,jd_66c8190b95dea,jd_4a649b75f718a'];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ['jd_5936a981e2178,jd_795e9688450eb,jd_780f6fb3e2795,jd_YPtTiIFkkvgm,jd_47a64747baa1a,jd_66c8190b95dea,jd_4a649b75f718a'];
//friendsArr内置太多会导致IOS端部分软件重启,可PR过来(此处目的:帮别人助力可得30g狗粮)
let friendsArr = ["jd_5936a981e2178", "jd_795e9688450eb", "jd_780f6fb3e2795", "jd_YPtTiIFkkvgm", "jd_47a64747baa1a", "jd_66c8190b95dea", "jd_4a649b75f718a"]
    ...
    if (cookiesArr[i]) {
      ...
      if ($.isNode()) {
        if (process.env.JOY_RUN_HELP_MYSELF) {
          ...
          fixPins.push(...run_pins.splice(run_pins.indexOf('jd_795e9688450eb'), 1));
