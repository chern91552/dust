...
echo "$lrr" | sed -e "s/RRAID/$1/g" > /ql/scripts/jd_live_redrain.js
...
# 添加今天的定时任务
#echo "1 8-23$(date "+ %-d %-m") * jtask lxk0301_live_redrain.js now"  >>  /jd/config/crontab.list

#echo "添加当天的lxk0301_live_redrain红包雨定时任务完成"

echo "顺便白嫖一下红包雨"

js jd_live_redrain now
